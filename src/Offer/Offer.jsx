    ...
    return (
        <div className="mt-14">
            <div className="text-center">
                <h2 className="text-4xl font-bold text-black py-2">Why <span className="text-[#F0151f]">Choose </span> Us</h2>
            </div>
            ...
            <div className=" lg:flex md:flex lg:gap-28 md:gap-10 mt-10 max-w-screen-xl mx-auto">
                ...
                <div>
                    <div className='text-center md:text-center lg:text-start '>
                        <h1 className="lg:mb-5 lg:text-3xl md:text-4xl text-2xl font-bold text-black">Best Valued deals you will ever find</h1>
                        <p className="lg:text-base md:text-base text-sm font-normal text-black">Discover the best deals you will ever find with our unbeatable offers. We are <br /> to providing you with the best value for you money, so you can enjoy top<br /> quality services and products without breaking the bank. <br />Our deals are designed to give you the ultimate renting experience, so dont miss out on your chance to save big.</p>
                        <div className='mt-10'>
